...
import * as gio_tls from "./gio-tls";
...
const config = {
    ...
    certificateArn: gio_tls.certificate.arn, // this certificate is created on the fly with terraformation. I'd like tofind out a way to store it to secrethub. 
};
